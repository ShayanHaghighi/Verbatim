    ...
    <>
      <div className="flex flex-col h-full w-full">
        ...
        <div className="flex flex-row flex-1 overflow-y-auto">
          {true && (
            <div
              className={`z-10 absolute ${location.pathname == "/game/play" && (burgerOpen ? "md:absolute" : "hidden")} md:static h-fill-available flex flex-col bg-[#210067] items-center justify-center ${burgerOpen ? "w-[100vw] left-0" : "w-[0vw] left-[-100px]"} transition-all duration-500 md:w-1/4 font-josefin`}
            >
